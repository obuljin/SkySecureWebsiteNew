                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="bd-service-details mb-50">
                                ...
                                {service.data.map((e: { desc: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined }, i: number) => (
                                    <p key={i} className="mb-8">{e.desc}</p>
                                ))}
