        ...
        <>
            ...
            <div className="container">   
                <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6 mb-30">
                    {/* <div className="col-xl-6 col-lg-6 mb-30"> */}
                        <div className="about-content d-flex flex-column gap-3" style={{}}>
                            ...
                            <strong style={{color: "#096bd8" , fontWeight: "900", fontSize: "18px" , fontFamily: "cerebri_sansbold"}}>– Suresh &amp; Nithin (founders)</strong>
