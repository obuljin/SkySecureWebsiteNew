                    ...
                    <div className="row ">
                        <div className="col-xl-6 col-lg-6   " >
                            <div className="margen">
                                ...
                                <p className="fw-bolder text-black  mb-20">Navigating the complexities of the India Digital Personal Data Protection (DPDP) Act is a complex and demanding task. It has far-reaching implications for businesses, fundamentally changing the way personal data is handled and processed.</p>
                                <p className=" text-black  mb-20">Skysecure, your accredited Microsoft security partner, can simplify your DPDP journey - from initial assessment to deployment, maintenance, and ongoing governance - through our tailored, leading-edge Microsoft security solutions and expert understanding of the Act.</p>
                                <p className=" text-black  mb-20">Microsoft’s comprehensive security solutions enable you to address data privacy, governance, compliance, and risk management in a consistent, integrated manner using unified solutions that provide unprecedented visibility and protection across your data - all powered by AI and automation.</p>
                            </div>
                        </div>
                        <div className=" col-xl-6 col-lg-6 ">
