...
const AboutTestContent = () => {
    return (
        ...
        <div className="testimonial-text">
          ...
          <div className="textimonial-text-svg">
          <svg
            aria-hidden="true"
            style={{ height: '20px', width: '20px', color: '#096BD8' }}
            className=".textimonial-text-svg e-font-icon-svg e-fas-user-tie"
            viewBox="0 0 448 512"
        ...
        >
            ...
            <div>
                <h4 style={{color:'#096BD8'}}>Saptesh Parish</h4>
                <span style={{  textTransform: 'lowercase',color:'#7A7A7A'}}>Director - Enterprise IT</span>
            </div>
