...
export const blogDataTwo = [
    {
      ...
      text: "The manufacturing industry in India has been experiencing significant growth and transformation in recent years. India has emerged as a global manufacturing hub, attracting both domestic and foreign investments. Several factors contribute to the growth of the manufacturing sector in India, including favorable government policies, advancements in technology, a skilledlabour force, and a large consumer […]",
      image: thumbOne,
      date: "JULY 08, 2023",
      user:"SURESH",
      message:'No Comments'
